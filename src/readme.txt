...
Основная идея заключается в использовании компонентов, как составляющих для графиков. Компоненты это готовые блоки, которые содержат определенную логику
...
3. Компоненты могут иметь свое API и параметры, что позволяет делать их максимально гибкими

Оптимизация
Графики созданные на этом фреймворке хорошо оптимизированы. Перерисовывание происходит только при необходимости, а элементы которые находятся за пределами видимости пропускаются
